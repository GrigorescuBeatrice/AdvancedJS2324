...
class SpaceObjectFactory{
    createObject(type,name,size,color,extraParams){
        ...
        const sun=factory.createObject('star','Sun','109 times larger then Earth','yellow',{temperature:5778});
        const earth = factory.createObject('planet','Earth','12,742km diameter','blue',{distanceFromSun:149.6});
        sun.shine();
        earth.orbit();
